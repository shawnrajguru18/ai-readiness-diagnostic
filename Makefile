...
docs:
	...
	@echo "  - docs/INDEX.md (index of every document, with phase and status)"
	@echo "  - docs/ci_cd/ci_cd_pipeline.md (this CI/CD setup)"
	@echo "  - docs/deployment/deploy_checklist.md (deployment requirements)"
	@echo "  - docs/audit/evaluation_suite.md (vulnerability tests)"
	@echo ""
