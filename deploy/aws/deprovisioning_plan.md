...
- **Checklist:** `deploy/aws/pre_destroy_checklist.md`
- **Verification:** `deploy/aws/post_destroy_validation.sh` (automated) + `deploy/aws/post_destroy_validation.md` (manual steps)
- **Script:** `deploy/aws/destroy_terraform.sh`
