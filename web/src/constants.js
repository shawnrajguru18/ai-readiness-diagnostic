...
export const DEMO_SCORECARD = {
    ...
    quick_wins: [
        {
            ...
            one_line_description: 'AI categorizes and routes invoice exceptions, reducing manual AP workload.',
            what_this_would_do: 'Auto-resolve routine AP exceptions and route complex cases with context, freeing the AP team for vendor management.',
        ...
        },
        {
            ...
            one_line_description: 'AI categorizes IT incidents, assigns severity, routes to the right tier.',
            what_this_would_do: 'Cut mean-time-to-assignment and lift tier-1 deflection across your ServiceNow estate.',
        ...
        },
        {
            ...
            one_line_description: 'AI reads regulatory documents and flags compliance issues for review.',
            what_this_would_do: 'Lift compliance review coverage of customer communications while catching more issues, directly addressing the governance gap.',
    ...
    executive_narrative: {
        headline: 'MeridianFS is at the Developing stage: real experimentation, with governance posture the constraint on scaling to production.',
        paragraphs: [
